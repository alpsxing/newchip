...
static int __init dw_wdt_init_driver(void)
{
	return platform_driver_probe(&dw_wdt_driver, dw_wdt_drv_probe);
}
module_init(dw_wdt_init_driver);

static void __exit dw_wdt_exit_driver(void)
{
	platform_driver_unregister(&dw_wdt_driver);
}
module_exit(dw_wdt_exit_driver);
